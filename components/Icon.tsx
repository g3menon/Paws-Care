...
const CalendarIconFilled = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
const HeartIconFilled = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-1.383-.597 15.218 15.218 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.11-4.789 9.25a15.218 15.218 0 01-4.244 3.17 15.247 15.247 0 01-1.383.597l-.022.012-.007.004-.004.001a.752.752 0 01-.704 0l-.003-.001z" />
  </svg>
);
const UserIconFilled = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
const BuildingOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6h1.5m-1.5 3h1.5m-1.5 3h1.5M6.75 21v-2.25a2.25 2.25 0 012.25-2.25h3a2.25 2.25 0 012.25 2.25V21m-8.25-18h8.25a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 0116.5 21h-8.25a2.25 2.25 0 01-2.25-2.25V5.25A2.25 2.25 0 016 3z" />
    </svg>
);
...
const ICONS: { [key: string]: {
    outline: (props: React.SVGProps<SVGSVGElement>) => React.ReactElement;
    filled?: (props: React.SVGProps<SVGSVGElement>) => React.ReactElement;
}} = {
  HomeIcon: { outline: HomeIcon, filled: HomeIconFilled },
  ...
  ChevronLeftIcon: { outline: ChevronLeftIcon },
  ChevronDownIcon: { outline: ChevronDownIcon },
  BuildingOfficeIcon: { outline: BuildingOfficeIcon },
  MenuIcon: { outline: MenuIcon },
  AdjustmentsHorizontalIcon: { outline: AdjustmentsHorizontalIcon },
  CreditCardIcon: { outline: CreditCardIcon },
  QuestionMarkCircleIcon: { outline: QuestionMarkCircleIcon },
  ...
  MapPinIcon: { outline: MapPinIcon },
  ChatBubbleLeftEllipsisIcon: { outline: ChatBubbleLeftEllipsisIcon },
  PaperAirplaneIcon: { outline: PaperAirplaneIcon },
  PencilIcon: { outline: PencilIcon },
  CheckIcon: { outline: CheckIcon },
  SparklesIcon: { outline: SparklesIcon },
  BookmarkIcon: { outline: BookmarkIcon, filled: BookmarkIconFilled },
  ArrowTopRightOnSquareIcon: { outline: ArrowTopRightOnSquareIcon },
};
...
const Icon: React.FC<IconProps> = ({ name, className, filled = false }) => {
  ...
  const IconComponent = filled && iconSet.filled ? iconSet.filled : iconSet.outline;
